...
sudo pacman -Syu --needed git stow kitty neofetch wget unzip curl wofi vesktop-bin imagemagick waybar  pipewire pipewire-pulse wireplumber xdg-desktop-portal-hyprland ttf-nerd-fonts-symbols --noconfirm
